    ...
    (try 
      (testing "Creating and retreiving an ad"
        (let [new-ad {:ad-type "ad.type/real-estate" 
          ...
          (is (= (set (:res-features new-ad)) (set (:res-features returned-ad))))   
          ...
          (let [response (http/get (str url "/ads/" (:ad-id returned-ad)))
            ...
            (is (= (set (:res-features new-ad)) (set (:res-features stored-ad))))   
    ...
    (try 
      (testing "Creating and updating an ad"
        (let [new-ad {:ad-type :ad.type/real-estate 
              ...
              update-res (http/put (str url "/ads/" (:ad-id updated-ad)) {:form-params updated-ad :content-type :json})
    ...
    (try 
      (testing "Creating and deleting an ad"
        (let [new-ad {:ad-type :ad.type/real-estate 
          ...
          (is (= 204 (:status (http/delete (str url "/ads/" (:ad-id stored-ad))))))
          (is (= 404 (:status (http/get (str url "/ads/" (:ad-id stored-ad)) {:throw-exceptions false}))))))  
      (finally
        (component/stop system)))))
